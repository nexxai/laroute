...
namespace Jojo\Laroute\Generators;

use Illuminate\Filesystem\Filesystem;
use Jojo\Laroute\Compilers\CompilerInterface as Compiler;
...
class TemplateGenerator implements GeneratorInterface
{
     ...
     *
     * @var \Jojo\Laroute\Compilers\CompilerInterface
     */
    protected $compiler;
     ...
     *
     * @param $compiler   \Jojo\Laroute\Compilers\CompilerInterface
